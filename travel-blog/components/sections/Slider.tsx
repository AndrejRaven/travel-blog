...
const posts = [
  {
    ...
    title: "Pad Thai",
    caption:
      "Nasz absolutny numer jeden. Pad Thai to nic innego jak smażony makaron z sosem, jajkiem, kiełkami fasoli, orzeszkami ziemnymi, limonką i opcjonalnie chili. Do wyboru warianty z tofu, kurczakiem lub krewetkami.",
  },
  {
    id: "2",
    ...
    caption:
      "Czyli numer jeden wśród deserów. Składa się z ryżu (klejący, odpowiednio przygotowany), mleczka kokosowego i mango. Niebo w gębie!",
  },
  {
    id: "3",
    imageUrl: "/demo-images/demo-asset.png",
    title: "Ryż smażony",
    caption:
      "Po prostu ryż smażony z sosem sojowym, jajkiem i przyprawami. Warianty z tofu, kurczakiem, krewetkami i owocami morza.",
  },
  {
    id: "4",
    imageUrl: "/demo-images/demo-asset1.png",
    title: "Tom Yum",
    caption: "Kwaśna zupa z krewetkami. Dosyć pikantne.",
  },
  {
    id: "5",
    imageUrl: "/demo-images/demo-asset.png",
    title: "Pad Kra Pao",
    caption: "Mięso mielone z tajską bazylią i jajkiem. Podawane z ryżem.",
  },
  {
    id: "6",
    imageUrl: "/demo-images/demo-asset1.png",
    title: "Som Tum (Yum Som Tum)",
    caption:
      "Jest to kwaśna i ostra sałatka z zielonej, nie dojrzałej papai, z dodatkiem pomidorów i orzeszków ziemnych.",
  },
  {
    id: "7",
    imageUrl: "/demo-images/demo-asset.png",
    ...
    caption:
      "Czyli łagodne curry z ziemniakami i orzeszkami o słodko-kwaśnym smaku.",
  },
];
