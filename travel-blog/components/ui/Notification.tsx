...
export default function Notification({
  ...
  return (
    <div
      className={`fixed top-4 right-4 z-50 max-w-sm w-full p-4 rounded-lg border shadow-lg transition-all duration-300 ${getStyles()}`}
    >
...
// Hook do zarządzania powiadomieniami
